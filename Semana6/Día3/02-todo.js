...
let tareas = []; //aquí almacenaré las tareas a mostrar
...
function dibujarTareas() {
    //cada vez que se ejecute dibujarTareas lo primero que hago es decir que el contenido HTML va a ser "" nada
    ulTareas.innerHTML = "";
